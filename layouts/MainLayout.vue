  ...
  <div id="MainLayout" class="w-full fixed z-50">
    ...
    >
      <ul
        ...
        "
      >
      <li class="border-r border-r-gray-400 px-3 hover:text-red-400 cursor-pointer">
          Sell on AliExpress
      </li>
      <li class="border-r border-r-gray-400 px-3 hover:text-red-400 cursor-pointer">
          Cookie Preferences
      ...
      <li hover:text-[#FF4646] cursor-pointer>
        ...
        >
          <div v-if = "true">
            ...
            <div class="flex items-center gap-1 mb-3"> 
              <NuxtLink
              to ="/auth"
              class="bg-[#FF4646] text-center w-full text-[16px] rounded-small text-white font-semibold p-2"
              >
              Login/Register
              </NuxtLink>
            </div>
            ...
            <div class="relative">
                ...
                <div class="absolute bg-white max-w-[700px] h-auto w-full">
                  <div  v-if = false class="p-1">
                    <NuxtLink 
                     to ="/item/1"
                     class="flex items-center justify-between w-full cursor-pointer hover:bg-gray-300"
                    >
